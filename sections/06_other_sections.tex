...
We would like to thank the support that we received from the SDE data team (Thomas Bolton \& Jadene Lewis) for their diligent work to prepare and provide the datasets for this work, and the coding support from the Databricks team.
...
The corresponding author, Michael Allen, is the guarantor of the paper (PI on the COVID IMPACT project funding).